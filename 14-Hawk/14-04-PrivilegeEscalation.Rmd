...
Algo que hemos visto, es que el puerto **8082** no se podia ver por reglas definidas en el systema.
Como ya hemos pensado en technicas de port forwarding, installamos **Chisel**.
...
1. En la maquina de attackante creamos un servidor 
...
Si pinchamos en preferencias y despues en **Permitir conexiones desde otros ordenadores** ya podemos navigar desde la
...
Encontramos un exploit en python que permitiria ejecutar **Alias Arbitrary Code execution**. Lo analyzamos:
