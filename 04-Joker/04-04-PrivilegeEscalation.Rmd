...
### Privilege escalation al usuario alekos {-}
...
Testeamos el commando **sudoedit**
...
1. Nos connectamos al usuario alekos por ssh
...
### Privilege escalation al usuario root {-}
...
Saviendo esto estamos intuiendo que la tarea cron ejecuta un commando del estilo: `tar -cvf backup/test.tar.gz /home/alekos/development/*`.
Aqui el problema es que si el commando es este, el symbolo `*` permitteria burlar el commando tar con breakpoints. Lo que queremos ejecutar seria
...
El echo es que si el commando de la tarea cron tiene el asterisco y que ficheros tienen nombres como `--checkpoint=1` y `--checkpoint-action=exec/bin/sh`,
