...
Aqui vemos que las connecciones por TCP no funccionan. Puede ser porque hay reglas definidas que no permitten utilizar TCP y S4vitar
...
- tenemos connectividad por trasa ICMP
- el protocolo TCP esta blockeado
- el protocole UDP esta blockeado

Segun esta analysis intentamos crearnos una reverse shell por **ICMP**
...
Aqui como tenemos que passar por la url de la web para enviarnos el fichero, tenemos que preparar el fichero.

1. Ejecucion de commandos prealables en nuestra maquina
...
1. Borramos todo los commentarios que hay en el fichero
...
1. Controllamos en la web si el fichero existe
...
Por fin estamos a dentro de la maquina ;)
