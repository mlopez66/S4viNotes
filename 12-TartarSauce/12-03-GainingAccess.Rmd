...
1. Montamos un servidor web desde la maquina de attackante
...
Aqui vemos que hay un usuario onuma en el directorio home pero no tenemos capacidad de accesso. Tambien vemos que podemos uzar 
el commando tar como el usuario **onuma** sin proporcionar contraseña.

### User Pivoting al usuario onuma {-}

Como es possible utilizar el commando tar como el usuario onuma sin propocionar contraseña, vamos a la pagina [GTFOBINS](https://gtfobins.github.io/) y buscamos 
...
### Automatizamos el accesso en bash {-}
